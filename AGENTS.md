...
A pre-analyzed knowledge vault for this codebase lives at `/Users/oblivious/Documents/ai-dlc-vault`. It contains per-file and per-directory analysis notes generated by Ollama, structured for fast lookup via the `obsidian-mcp` MCP server.
